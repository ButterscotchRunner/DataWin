**Progress:** 372/1409 (26.40170333569908%)

Tested against GameMaker: Studio 1.0.198
...
| `YoYo_EnableInAppPurchases` | 🚫 |
| `YoYo_RestoreInAppPurchases` | 🚫 |
| `YoYo_RetrieveInAppPurchases` | 🚫 |
| `YoYo_AcquireInAppPurchase` | 🚫 |
| `YoYo_GetPurchasedDetails` | 🚫 |
| `YoYo_ProductPurchased` | 🚫 |
| `iap_enable` | 🚫 |
| `iap_restore` | 🚫 |
| `iap_retrieve` | 🚫 |
| `iap_acquire` | 🚫 |
